      ...
      <div className="mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Optimización para Motores de Búsqueda. Mejoramos la visibilidad de tu sitio web en los resultados de búsqueda, aumentando su tráfico y posicionamiento en Google y otros buscadores.
          </p>
        ...
        <div className="text-center mb-12 py-12">
          ...
          <ul className="flex flex-col list-none space-y-4 max-w-2xl items-center justify-center mx-auto py-12">
            ...
            <li className="text-stone-700 dark:text-stone-300">
              ...
              Aumentamos la presencia de tu sitio web en los motores de búsqueda,
              lo que mejora significativamente su exposición y alcance.
            </li>
            <CheckCircle className="text-stone-500 h-20 w-20" />
            <li className="text-stone-700 dark:text-stone-300">
              <span className="text-stone-700 dark:text-stone-50 text-xl text-left">
            ...
            <li className="text-stone-700 dark:text-stone-300">
              ...
              Nos encargamos de actualizar y ajustar continuamente tu estrategia
              de SEO para adaptarla a las nuevas tendencias y algoritmos.
            </li>
          </ul>
        </div>
