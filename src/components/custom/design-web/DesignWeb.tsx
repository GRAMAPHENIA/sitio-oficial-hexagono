  ...
  return (
    <section className="flex flex-col items-center mx-auto text-center pb-12">
      <div className="mx-auto px-6 mt-12">
        ...
        <div>
          <h1
            className={`${vollkorn.className} text-4xl lg:text-6xl font-extrabold text-slate-800 dark:text-slate-200 mt-5 lg:mt-16`}
          >
            Diseño Web
          </h1>
          <section>
            <p className="text-md text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:text-balance">
            ...
            {advantages.map((advantage, index) => (
              ...
              >
                ...
                <section className="py-10 px-6 text-center">
                  ...
                  <p className="px-5 lg:px-0 text-balance">{advantage.content}</p>
                </section>
              </li>
            ))}
          </ul>
