...
export default function FeatureCard({ feature }: FeatureCardProps) {
  return (
    <Card className="px-6 border-none bg-transparent shadow-none relative my-10 lg:my-20">
      <CardContent className="flex flex-col justify-between items-center h-full">
        <div>
          <Image
            ...
            width={300}
            height={300}
            className="h-40 w-auto animate-bounce-smooth px-4 pb-4"
          />
          <Image
            ...
            width={300}
            height={300}
            className="h-44 w-auto absolute top-20 right-8 -z-10 dark:hidden"
          />
          <Image
