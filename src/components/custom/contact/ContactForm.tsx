...
export default function ContactForm() {
  ...
  return (
    <section
      id="contact-form"
      className="scroll-m-10 m-auto text-center lg:rounded-xl border border-input px-4 lg:w-full text-sm bg-white dark:bg-hexagon shadow-box py-16 mx-8 lg:mx-0 max-w-4xl rounded-lg"
    >
