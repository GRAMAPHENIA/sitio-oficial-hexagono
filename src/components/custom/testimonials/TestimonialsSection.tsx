...
export default function TestimonialsSection() {
  return (
    <section className="flex flex-col justify-center items-center text-center mb-20 lg:mb-40 py-10 px-6 md:px-16 lg:px-40 max-w-7xl ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-20 w-full">
